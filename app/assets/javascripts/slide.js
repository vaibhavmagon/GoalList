...
function ssInit() {
  ...
  jQuery(function ($) {
    ...
    function fullScreen(this_s_window) {
      ...
      base_img.src = $(this_s_window).find('img').first().attr('src'); /*var rendered_img = $(this_s_window).find('img').first();*/
